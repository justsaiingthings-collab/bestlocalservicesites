...
export const metadata: Metadata = {
  title: `Cleaning Services in ${config.primaryLocation} | ${config.businessName}`,
  description: `All cleaning services from ${config.businessName}. Serving ${config.locations.map((l: any) => l.city).join(", ")}.`,
};
    ...
    <>
      <section className="bg-slate-900 text-white py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black mb-4">Our Cleaning Services</h1>
          <p className="text-slate-300 text-lg max-w-2xl">
            Serving Seattle, Bellevue & Redmond.
          </p>
        </div>
      </section>
