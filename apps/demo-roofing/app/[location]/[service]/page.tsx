...
export function generateMetadata({ params }: Props): Metadata {
  ...
  return {
    ...
    description: `${svc.shortDesc} Serving ${loc.city}${loc.county ? `, ${loc.county}` : ""}. Call ${config.phone} for same-day service.`,
  };
}
    ...
    <>
      ...
      <section className="relative min-h-[440px] flex items-center bg-slate-950 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(to right, rgba(0,0,0,0.85) 0%, rgba(0,0,0,0.6) 60%, rgba(0,0,0,0.3) 100%)",
          }}
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 w-full px-4 py-16">
          <div className="max-w-6xl mx-auto max-w-2xl">
            ...
            <p className="text-slate-200 text-lg mb-8">
              {svc.longDesc ?? svc.shortDesc}{" "}
              Serving {loc.city}{loc.county ? `, ${loc.county}` : ""} and surrounding areas.
            </p>
        ...
        <section className="bg-white py-12 px-4 border-b">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-black text-slate-900 mb-6">
              Common {svc.name.toLowerCase()} problems in {loc.city}
            </h2>
      ...
      <section className="bg-slate-50 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-black text-slate-900 mb-6">
            More roofing services in {loc.city}
          </h2>
      ...
      <section className="bg-white py-12 px-4 border-t">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-black text-slate-900 mb-6">
            {svc.name} in other service areas
          </h2>
          <div className="flex flex-wrap gap-3">
            {config.locations
