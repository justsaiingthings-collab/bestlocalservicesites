      ...
      <section className="bg-white py-16 px-4">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-5">
              <div>
                ...
                <a
                  ...
                  className="text-2xl font-black text-orange-500 hover:text-orange-600"
                >
                  {config.phone}
                </a>
                {config.isEmergencyService && (
            ...
            <a
              href={`tel:${phoneDigits}`}
              className="mt-8 flex items-center gap-3 bg-orange-500 hover:bg-orange-600 text-white font-black text-xl px-7 py-5 rounded-xl transition-colors w-fit"
            >
              📞 Call {config.phone}
            </a>
          </div>
