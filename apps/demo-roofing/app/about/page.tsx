            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div>
                <div className="text-3xl font-black text-orange-500">
                  {config.yearsInBusiness ?? (new Date().getFullYear() - (config.yearFounded ?? 2010))}+
                </div>
                <div className="text-slate-500 text-sm">Years in business</div>
              </div>
              <div>
                <div className="text-3xl font-black text-orange-500">
                  {config.jobsCompleted ? `${(config.jobsCompleted / 1000).toFixed(1)}k` : "1.2k+"}
                </div>
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-6">
              ...
              <p className="text-slate-300 text-sm mb-4">
                {config.isEmergencyService
                  ? "We answer 24/7. No call centers."
                  : "Mon–Sat, 7am–7pm. Real people answer."}
              </p>
              <a
