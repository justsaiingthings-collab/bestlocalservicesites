...
export const metadata: Metadata = {
  title: `Painting Services in ${config.primaryLocation} | ${config.businessName}`,
  description: `All painting services from ${config.businessName}. Serving ${config.locations.map((l: any) => l.city).join(", ")}.`,
};
    ...
    <>
      <section className="bg-slate-900 text-white py-14 px-4">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black mb-4">Our Painting Services</h1>
