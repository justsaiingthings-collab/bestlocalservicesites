        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <div>
                <div className="text-3xl font-black text-orange-500">{config.yearsInBusiness}+</div>
                <div className="text-slate-500 text-sm">Years in business</div>
              </div>
              <div>
                <div className="text-3xl font-black text-orange-500">{config.jobsCompleted ? `${(config.jobsCompleted/1000).toFixed(1)}k` : "1k+"}</div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-900 text-white rounded-2xl p-6">
              ...
              <p className="text-slate-300 text-sm mb-4">
                {config.isEmergencyService ? "We answer 24/7. No call centers." : "Mon–Sat, 7am–7pm."}
              </p>
